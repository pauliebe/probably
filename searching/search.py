...
#Combines all the results into a JSON file called query.json, into the folder specified
...
def search_LOC(query):
		url = 'https://loc.gov/pictures/search/photos/?q=%22'+ query + '%22&fi=title&fo=json' 
